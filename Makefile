...
fs.img: mkfs README PATH.txt $(UPROGS)
	./mkfs fs.img README PATH.txt $(UPROGS)
...
PRINT = runoff.list runoff.spec README PATH.txt toc.hdr toc.ftr $(FILES)
...
EXTRA=\
	...
	printf.c umalloc.c\
	README PATH.txt dot-bochsrc *.pl toc.* runoff runoff1 runoff.list\
